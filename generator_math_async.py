...
class TreeNode:
    ...
    def format_dim_prompt(self):
        ...
        prompt = f"""As a math expert, your task is to examine the following MATH questions identify the SINGLE most significant dimension that characterizes the question space and differentiates these questions.
Questions:
{samples}
...
"""
    ...
    def format_expand_prompt(self, dimension, attribute_values):
        ...
        prompt = f"""As a math expert, your task is to supplement the potential attribute values for a specified dimension in order to comprehensively model the entire space of questions.
...
"""
    ...
    def format_gen_prompt(self):
        if self.is_root():
            prompt = """As a math expert, generate 10 high school competition-level math questions in MATH dataset style.
...
"""
            ...
            prompt = f"""As a math expert, generate 10 high school competition-level math questions in MATH dataset style.
